...
<form class="form-inline ml-auto" method="post" action="login">
	<input class="form-control mr-sm-2" type="text" name="id" id="id" placeholder="아이디" onclick="this.select()"/><br/>
	<input class="form-control mr-sm-2" type="password" name="password" id="password" placeholder="비밀번호" onclick="this.select()"/></br/>
