...
<script type="text/javascript">
  ...
  var idAndFolder = {} //북마크 추가할 때 필요한-센텐스의 id(din컬럼)이랑 선택한 folder
  
  
//북마크추가1-추가버튼눌러서 모달뜰 때, 북마크의 id(din컬럼)저장해놓기
  $(document).on(
      'click',
      '.addBookmark',
      function(e) {
        
        //북마크추가 버튼 클릭하면 id을 세팅해놓음  
